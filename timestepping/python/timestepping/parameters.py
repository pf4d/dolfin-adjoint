...
add_parameter(dolfin.parameters["timestepping"]["pre_assembly"]["linear_forms"], "compress_matrices", False)
...
add_parameter(dolfin.parameters["timestepping"]["pre_assembly"]["bilinear_forms"], "compress_matrices", False)
